...
export default function HeroSection() {
  return ( 
    <section className="mx-auto flex min-h-[30vh] max-w-6xl flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="max-w-3xl text-4xl font-bold tracking-tight text-gray-900 dark:text-white md:text-6xl">
      ...
      <div className="mt-8 flex gap-4">
        <Link
          href="/projects"
         className="rounded-lg border border-gray-300 px-5 py-3 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:border-gray-700 dark:text-white dark:hover:bg-gray-900"
        >
          View Projects
        </Link>
        <Link
